...
private class Solution131701 {
    fun solution(elements: IntArray): Int {
        val elementsDouble = IntArray(elements.size * 2) {
...
private fun main() {
    val solution131701 = Solution131701()
    println(solution131701.solution(intArrayOf(7, 9, 1, 1, 4)))
}