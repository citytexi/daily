...
private class Solution12985 {
    fun solution(n: Int, a: Int, b: Int): Int = when (n) {
        2 -> 1
        else -> {
            var answer = 0
            ...
            while (iterA != iterB) {
                iterA = iterA / 2 + iterA % 2
                iterB = iterB / 2 + iterB % 2
...
private fun main() {
    val solution = Solution12985()
    println(solution.solution(n = 8, a = 4, b = 7))
    println(solution.solution(n = 2, a = 1, b = 2))
}