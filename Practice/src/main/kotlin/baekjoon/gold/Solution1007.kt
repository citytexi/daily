...
private class Solution1013 {
    ...
    fun printCondition(condition: Boolean) = when (condition) {
        true -> println("YES")
        false -> println("NO")
    }
}
...
private fun main() = with(System.`in`.bufferedReader()) {
    ...
    inputList.map(solution::solution).forEach(solution::printCondition)
}